        ...
        <>
            <nav className='pl-4 bg-white duration-100 pty-1'>
                {pageNavs.length>3 && <div className='flex'>
                    <div className='flex'>
                        <Link href={pageNavs[0].link} className='pr-2 pt-0.5 pb-1 pl-1 hover:bg-neutral-200 text-neutral-500'>
                            <IoHomeOutline size={18} />
                        </Link>
                        <p className='cursor-default text-neutral-500'>/</p>
                        <DetailNav pageNav={pageNavs.slice(1,-2)} />
                        <p className='cursor-default text-neutral-500'>/</p>
                        <Link href={pageNavs[pageNavs.length - 2].link} className='px-2 pt-0.5 pb-1 hover:bg-neutral-200 text-neutral-500 truncate max-w-[clamp(100px, 20vw, 250px)]'>
                            {pageNavs[pageNavs.length - 2].title}
                        </Link>
                        <p className='cursor-default text-neutral-500'>/</p>
                        <Link href={pageNavs[pageNavs.length - 1].link} className='px-2 pt-0.5 pb-1 hover:bg-neutral-200 text-neutral-500 truncate max-w-[clamp(100px, 20vw, 250px)]'>
