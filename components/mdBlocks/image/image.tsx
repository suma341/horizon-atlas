...
export default function ImageBlock(props: Props) {
    try{
            ...
            <>
                ...
                onMouseLeave={() => setIsHovered(false)}>
                    ...
                    <p className='text-sm m-0 text-neutral-600' style={{width: "fit-content", textAlign: "left"}}>
                        {Array.isArray(data.parent) && data.parent.map((text)=>{
                        ...
                        {(!Array.isArray(data.parent) || data.parent.length===0) && <span className='opacity-0' >a</span>}
                    </p>
                </div>
        ...
        throw new Error(`error in Image error: ${e}`)
    }
}
