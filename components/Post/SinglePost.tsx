...
const SinglePost = (props:Props) => {
    const {title, tags, slug} = props.postData;
            ...
            {isPagenationPage ? (
                <section className='mb-4 mx-5 rounded-md p-3 shadow-md hover:shadow-none hover:translate-y-1 hover:bg-neutral-50 transition-all duration-200 border'>
                    <div className='flex w-auto h-9 my-1'>
                        <Image src={`/horizon-atlas/notion_data/eachPage/${slug}/icon.png`} alt={title} width={30} height={30} className='relative w-8 h-auto m-0 mr-1 bottom-1' />
                ...
                <section className='mb-4 mx-5 rounded-md p-3 shadow-md hover:shadow-none hover:translate-y-1 hover:bg-neutral-50 transition-all duration-200 border'>
                    <div className='flex w-auto h-9 my-1'>
                    <Image src={`/horizon-atlas/notion_data/eachPage/${slug}/icon.png`} alt={title} width={30} height={30} className='w-9 h-auto m-0 mr-1 relative bottom-1' />
